                ...
                <div className="z-10 relative">
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row sm:space-x-10">
                        ...
                        <div className="font-inter text-2xl pt-4 sm:pt-6">
                            ...
                            <a href="https://www.eventbrite.com/e/hyper-registration-136208510321" className="mt-8 px-4 py-2 text-xl rounded-xl border border-white hoverr:bg-white hover:text-black">
                                    Sign up
                            </a>
                        </div>
                    </div>
